...
const createGoldMedalTable = () => {
  return "CREATE TABLE GoldMedal (id: INTEGER PRIMARY KEY NOT NULL, year: INTEGET NOT NULL, city: TEXT NOT NULL, season: TEXT NOT NULL, name: TEXT NOT NULL, country:TEXT NOT NULL, gender:TEXT NOT NULL, sport:TEXT NOT NULL, discipline:TEXT NOT NULL, and event: TEXT NOT NULL)";
};
...
const goldMedalNumber = (country) => {
  return "SELECT SUM(medal) FROM Country WHERE country = $country AND ";
};
